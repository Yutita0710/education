<template>
  <div class="text-[#707781]">
    ...
    >
      <table class="w-full border-collapse sm:text-base font-bold">
        <thead>
          <tr class="bg-[#E2EDFC]">
            <th class="border px-2 py-[0.7rem] whitespace-nowrap w-[50px]">
              ลำดับ
            </th>
            <th class="border px-2 py-[0.7rem] whitespace-nowrap w-[200px]">
              ชื่อสถาบันการศึกษา
            </th>
            <th class="border px-2 py-[0.7rem] whitespace-nowrap w-[250px]">
              ชื่อหลักสูตร
            </th>
            <th class="border px-2 py-[0.7rem] whitespace-nowrap w-[200px]">
              หลักสูตร
            </th>
            <th class="border px-2 py-[0.7rem] whitespace-nowrap w-[100px]">
              ระดับการศึกษา
            </th>
            <th class="border px-2 py-[0.7rem] whitespace-nowrap w-[100px]">
              หลักสูตรสำหรับ
            ...
            <th
              ...
              class="border px-2 py-[0.7rem] whitespace-nowrap w-[30px]"
            >
              สถานะ
            </th>
            <th
        ...
        <tbody>
          ...
          >
            ...
            <!-- สถานะ -->
            <td v-if="isAdminComputed" class="border px-2 py-1 text-center">
              <span
            ...
            <!-- จัดการ -->
            <td v-if="isAdminComputed" class="border px-2 py-1">
...
// ใช้ค่า isAdmin จากพร็อพ ถ้าไม่ส่งมาให้ fallback จาก token
const isAdminComputed = computed(
  () => props.isAdmin ?? !!localStorage.getItem("token")
);
